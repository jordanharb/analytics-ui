...
const createMessageId = () => {
  ...
  useEffect(() => {
    ...
    if (!historyManagerRef.current) {
      historyManagerRef.current = new ChatHistoryManager('campaign_finance');
      ...
      <div className="flex-1 flex flex-col max-w-6xl mx-auto w-full h-full overflow-hidden">
          ...
          {messages.length === 0 && !isStreaming && (
            <div className="max-w-2xl mx-auto text-center py-12">
              <div className="card card-elevated p-8">
                <h3 className="text-lg font-semibold mb-4">Campaign Finance & Legislative Intelligence</h3>
                <p className="text-gray-600 mb-4">I can help you:</p>
                <ul className="text-left text-gray-600 mb-6 space-y-2">
                  <li className="flex items-start">
                    <span className="mr-2">•</span>
                    Search Arizona campaign committees and donor networks
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2">•</span>
                    Connect donations to legislative votes and sessions
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2">•</span>
                    Summarize transactions, top donors, and cash on hand
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2">•</span>
                    Surface Woke Palantir events when relevant
                  </li>
                </ul>
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  <button
                    className="chip"
                    onClick={() => handleSendMessage('List the campaign finance tools you can run.')}
                  >
                    "List the campaign finance tools you can run."
                  </button>
                  <button
                    className="chip"
                    onClick={() => handleSendMessage('Show the most recent transactions for entity 1234.')}
                  >
                    "Show the most recent transactions for entity 1234."
                  </button>
                  <button
                    className="chip"
                    onClick={() => handleSendMessage('Compare major donors to the last session votes for Anthony Kern.')}
                  >
                    "Compare major donors to Anthony Kern votes."
                  </button>
                </div>
              </div>
            </div>
        ...
        <div className="flex-shrink-0 border-t border-gray-200 px-6 py-4">
          <ChatInput
            ...
            placeholder="Ask about donations, bills, or events..."
          />
        </div>
      </div>
    </div>
