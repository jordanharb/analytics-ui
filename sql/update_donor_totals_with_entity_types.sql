-- Update search_donor_totals_window function to include entity type information
...
BEGIN
  ...
  LEFT JOIN public.cf_entity_types et ON et.entity_type_id = e.entity_type_id
  ORDER BY
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.search_donor_totals_window(bigint, integer[], integer, integer, integer, integer[], vector, numeric, date, date, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.search_donor_totals_window(bigint, integer[], integer, integer, integer, integer[], vector, numeric, date, date, integer) TO anon;
GRANT EXECUTE ON FUNCTION public.search_donor_totals_window(bigint, integer[], integer, integer, integer, integer[], vector, numeric, date, date, integer) TO service_role;