-- Drop and recreate the get_person_sessions function to include bill count for the specific legislator
...
AS $$
  ...
  LEFT JOIN LATERAL (
    -- Count unique bills voted on by this legislator in this session
