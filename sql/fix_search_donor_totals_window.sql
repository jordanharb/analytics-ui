-- Fix for search_donor_totals_window return type mismatch
-- The entity_name column is character varying(500) but function expects text
...
RETURNS TABLE (
  ...
  entity_name character varying,  -- Changed from 'text' to 'character varying' to match cf_transaction_entities table
